    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-0 pb-24 bg-gradient-to-b from-background to-secondary/20">
      <div className="max-w-5xl mx-auto text-center mb-12 space-y-6">
        ...
        <motion.div
          ...
          className="inline-flex items-center bg-blue-600 text-white rounded-full text-sm font-medium overflow-hidden border-2 border-blue-600"
        >
        ...
        <motion.h1
          ...
          className="text-[90px] font-bold leading-[1.1]"
        >
          Improve Your
          <br />
          Business with AI
